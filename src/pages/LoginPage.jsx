        ...
        <div>
            ...
            <div className="auth-wrap">
                <div className="auth-box">
                    <div className="auth-eyebrow">Välkommen tillbaka</div>
                    <div className="auth-title">Logga in</div>
                    <div className="auth-sub">Ange dina uppgifter för att fortsätta</div>
                    ...
                    <button className="auth-btn" onClick={handleSubmit}>Logga in</button>
                    <a href="/register" className="auth-link">Inget konto? <span>Registrera dig</span></a>
                    <a href="/reset-password" className="auth-link">Glömt lösenordet?</a>
                </div>
            </div>
        </div>
    )
