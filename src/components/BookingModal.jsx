...
const styles = `
    ...
    .bm-input:-webkit-autofill:hover,
    .bm-input:-webkit-autofill:focus,
    .bm-input:-webkit-autofill:active {
        -webkit-box-shadow: 0 0 0px 1000px #120d05 inset !important;
        -webkit-text-fill-color: #f5edd8 !important;
        caret-color: #f5edd8 !important;
...
export default function BookingModal() {
    ...
    return (
        <>
            ...
            >
                <DialogTitle sx={{ pb: 0, bgcolor: '#1a1208', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <DialogContent sx={{ pt: 2, bgcolor: '#1a1208' }}>
                    {submitted ? (
                        ...
                        <form onSubmit={handleSubmit} autoComplete="off">
                            <Stack spacing={1.5} sx={{ mt: 1 }}>
                                <div className="bm-field">
                                    ...
                                    <input className="bm-input" name="name" value={form.name} onChange={handleChange} required placeholder="Ditt namn" autoComplete="new-password" />
                                </div>
                                <div className="bm-field">
                                    <label className="bm-label">E-post</label>
                                    <input className="bm-input" name="email" value={form.email} onChange={handleChange} required placeholder="din@email.se" autoComplete="new-password" />
                                </div>
                                <div className="bm-row">
                                    <div className="bm-field">
                                        <label className="bm-label">Datum</label>
                                        <input className="bm-input" name="date" value={form.date} onChange={handleChange} required placeholder="ÅÅÅÅ-MM-DD" autoComplete="new-password" />
                                    </div>
                                    <div className="bm-field">
                                        <label className="bm-label">Tid</label>
                                        <input className="bm-input" name="time" value={form.time} onChange={handleChange} required placeholder="HH:MM" autoComplete="new-password" />
                                    </div>
                                </div>
                                <div className="bm-field">
                                    <label className="bm-label">Antal gäster</label>
                                    <input className="bm-input" name="guests" type="number" min="1" max="20" value={form.guests} onChange={handleChange} required autoComplete="new-password" />
                                </div>
                                <button
                                    type="submit"
                                    style={{
