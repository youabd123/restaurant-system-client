                ...
                <Container maxWidth="md">
                    <Grid container spacing={4} sx={{ mb: 4 }}>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            ...
                            <Stack spacing={0.75}>
                                {[
                                    { day: 'Måndag – Fredag', hours: '11:00 – 22:00' },
                                    { day: 'Lördag – Söndag', hours: '12:00 – 23:00' },
                                ].map((row) => (
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row" spacing={2}>
                                <Box component={Link} to="/about" sx={{ fontFamily: "'DM Sans', sans-serif", color: 'rgba(245,237,216,0.35)', fontSize: '12px', textDecoration: 'none', transition: 'color 0.2s', '&:hover': { color: '#c9a96e' } }}>
                                    Om oss
                                </Box>
                                <Box component={Link} to="/contact" sx={{ fontFamily: "'DM Sans', sans-serif", color: 'rgba(245,237,216,0.35)', fontSize: '12px', textDecoration: 'none', transition: 'color 0.2s', '&:hover': { color: '#c9a96e' } }}>
                                    Kontakt
                                </Box>
                                <Box component={Link} to="/menu-items" sx={{ fontFamily: "'DM Sans', sans-serif", color: 'rgba(245,237,216,0.35)', fontSize: '12px', textDecoration: 'none', transition: 'color 0.2s', '&:hover': { color: '#c9a96e' } }}>
                                    Meny
                                </Box>
                            </Stack>
                        </Grid>
